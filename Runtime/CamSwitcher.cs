...
/// <summary>
/// This script is only necessary on Android. It connects the two cameras (GpsCam and ARCam) and 
...
public class CamSwitcher : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //so I turn of ARCam Objects (this is recommended)
    ...
    public void ShowArCamera()
    {
        ...
        Debug.Log("AR Cam should be active now");
